...
//     if (user && user.role !== 'ADMIN' && user.status === 'PENDING') {
//       try {
//         // Send approval email to admin - admin can reply directly to user
//         await sendEmail({
...
//         // Send confirmation email to user - user can reply to admin
//         await sendEmail({
//           to: user.email,
...
//             <p>Your account is pending admin approval.</p>
//             <p>You'll receive an email when your account is activated.</p>
//             <p><em>Reply to this email to contact the administrator.</em></p>
//           `
//         });
//       } catch (emailError) {
//         console.error('Email sending failed, but user was created:', emailError);
...
//           to: process.env.ADMIN_EMAIL,
//           replyTo: user.email,
//           replyToName: `${user.first_name} ${user.last_name}`,
//           subject: 'New User Approval Request',
//           html: `
//             <h2>New User Registration</h2>
//             <p>A new user requires approval:</p>
...
//           to: user.email,
//           replyTo: process.env.ADMIN_EMAIL,
//           replyToName: 'Fixiny Platform Admin',
//           subject: 'Registration Received',
//           html: `
//             <h2>Thank you for registering!</h2>
//             <p>Your account is pending admin approval.</p>
...
// //         }],
// //         from: { 
// //           email: process.env.VERIFIED_SENDER_EMAIL, // Use verified sender from env
// //           name: 'Fixiny Platform'
// //         },
// //         subject: mailOptions.subject,
// //         content: [
